            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4">Project / Project</h6>
                                ...
                                <div class="col-xl-2 col-md-4 col-12 h-100">
                                    <div class="position-relative">
                                        <label for="project_image">
                                            <img id="poster-image" src="https://placehold.co/400x300" height="330px" class="img-fluid shadow rounded">
                                        </label>
