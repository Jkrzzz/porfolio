            ...
            <div class="row g-4 ">
                <div class="col-12">
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <form action="{{ route('project-category.update', ['project_category' => $project_cat->id]) }}"
                            method="POST">
                            @method('PUT')
                            @csrf
                            <div class="mb-3">
                                <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                                <input type="text" name="name" value="{{ $project_cat->name }}" placeholder="name"
                            ...
                            <div class="form-check py-2">
                                ...
                                <input name="is_active" class="form-lebel" type="radio" value="1" id="active"
                                    @if ($project_cat->is_active == 1) checked required @endif />
                                <label class="form-check-label" for="active">
                                    Active
                                </label>
                                <br>
                                <input name="is_active" class="form-lebel" type="radio" value="0" id="in_active"
                                    @if ($project_cat->is_active == 0) checked required @endif />
