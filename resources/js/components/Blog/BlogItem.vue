<template>
    <li
        class="relative flex flex-col sm:flex-row xl:flex-col items-start rounded-lg blog__card"
    >
        <div class="order-1 sm:ml-6 xl:ml-0 p-5">
            ...
            <div class="prose prose-slate prose-sm text-dark-600">
                <p>
