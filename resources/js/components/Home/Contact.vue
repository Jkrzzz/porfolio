<template>
    <section class="contact section" id="contact_tag">
        <p class="text-center py-4">Get in touch</p>
        <h1 class="text-center text-3xl font-bold">Contact me</h1>
        <div class="contact__container container grid mt-16">
            <div class="contact__content">
                <h3 class="contact__title">Talk to me</h3>
                <div class="contact__info">
                    <div class="contact__card">
                        <i
                            class="fa-regular fa-envelope contact__card-icon"
                        ></i>
                    ...
                    <div class="contact__card">
                        <i
                            class="fa-brands fa-facebook-messenger contact__card-icon"
                        >
                        </i>
